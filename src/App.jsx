...
const demoUsers = {
  student: {
    ...
    role: 'student',
    label: 'Aluno',
    hint: 'joga X1, ve feedback e acompanha o ranking',
  },
  professor: {
    name: 'Prof. Carlos Eduardo',
    role: 'professor',
    label: 'Professor',
    hint: 'acompanha resultados, ranking e banco de perguntas',
  },
};
...
export default function App() {
  ...
  function login(nextRole) {
    setLoggedUser(demoUsers[nextRole]);
  ...
  return (
    <main className="login-screen">
      <section className="login-hero">
        ...
        <p>
          Entre como aluno para jogar e pontuar, ou como professor para acompanhar desempenho,
          ranking e configuracoes da liga.
        </p>
        <div className="login-grid">
          <button className="login-card" onClick={() => onLogin('student')}>
            <span>Aluno</span>
            <strong>Entrar na arena X1</strong>
            <small>Feedback didatico, explicacoes e ranking em tempo real.</small>
          </button>
          <button className="login-card professor" onClick={() => onLogin('professor')}>
            <span>Professor</span>
            <strong>Acessar painel tecnico</strong>
            <small>Analise resultados, simule pontuacao e gerencie perguntas.</small>
          </button>
        </div>
      </section>
    </main>
